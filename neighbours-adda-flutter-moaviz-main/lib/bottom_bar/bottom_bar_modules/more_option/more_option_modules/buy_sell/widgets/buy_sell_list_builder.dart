                ...
                showModalBottomSheet(
                  ...
                  builder: (context) {
                    return MapViewDataListBottomSheet(
                      ...
                      builder: (context, searchQuery) => RenderBuySellList(
...
class RenderBuySellList extends StatefulWidget {
  const RenderBuySellList({
    super.key,
    required this.logs,
  ...
  @override
  State<RenderBuySellList> createState() => _RenderBuySellListState();
}

class _RenderBuySellListState extends State<RenderBuySellList> {
              ...
              child: MultiBlocProvider(
                ...
                child: BlocListener<PostActionCubit, PostActionState>(
                  ...
                  child: SalesPostCardWidget(
                    key: ValueKey(salesPostDetails.id),
                    id: salesPostDetails.id,
                    media: salesPostDetails.media.first,
                    title: salesPostDetails.itemName,
                    category: salesPostDetails.category.subCategory.name,
                    address: salesPostDetails.location.address,
                    distance: salesPostDetails.distance,
                    price: salesPostDetails.price,
                    isBought: salesPostDetails.isBought,
                    isSold: salesPostDetails.isSold,
                  ),
                ),
              ),
            );
